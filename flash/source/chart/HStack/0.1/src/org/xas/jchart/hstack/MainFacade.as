package org.xas.jchart.hstack
{
	...
	import org.xas.jchart.hstack.controller.CalcCoordinateCmd;
	import org.xas.jchart.hstack.controller.ClearCmd;
	import org.xas.jchart.hstack.controller.DrawCmd;
	import org.xas.jchart.hstack.controller.FilterDataCmd;
	
	public class MainFacade extends BaseFacade implements ICommand
	{
		public static const name:String = 'StackFacade';
