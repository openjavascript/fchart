package org.xas.jchart.rate
{
	...
	import org.xas.jchart.rate.controller.CalcCoordinateCmd;
	import org.xas.jchart.rate.controller.ClearCmd;
	import org.xas.jchart.rate.controller.DrawCmd;
	import org.xas.jchart.rate.controller.FilterDataCmd;
	
	public class MainFacade extends BaseFacade implements IFacade
	{
		public static const name:String = 'RateFacade';
