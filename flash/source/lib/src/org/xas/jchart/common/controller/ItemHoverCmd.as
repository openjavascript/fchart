package org.xas.jchart.common.controller
{
	...
	public class ItemHoverCmd extends SimpleCommand implements ICommand {
		
		private var _config:Config;
		
		public function ItemHoverCmd() {
		...
		override public function execute( notification:INotification ):void{
			...
			if( ExternalInterface.available && _callBackSet && _callBackSet.itemHoverCallback ) {
