...
//				;
//				
//				var _y:Number = 0, _h:Number = 100;
//				
//				if( _item.data && _item.data.positive && _item.data.positive.length ){
//					_y = _item.data.positive[ _item.data.positive.length - 1 ].y;
//				}
//				Log.log( _item.x, _y, _item.width, _h );
//				
...
//				_item.width 
//				&& _h
//				&& _box.graphics.drawRect( _item.x, _y, _item.width, _h );
//				
//				_box.visible = false;
//				
//				_boxs.push( _box );
