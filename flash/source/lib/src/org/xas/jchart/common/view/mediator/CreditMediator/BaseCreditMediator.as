package org.xas.jchart.common.view.mediator.CreditMediator
{
	...
	public class BaseCreditMediator extends Mediator implements IMediator
	{
		...
		public function BaseCreditMediator( _text:String, _href:String )
		{
			super( name );
