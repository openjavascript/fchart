package org.xas.jchart.common.view.mediator.ToggleBgMediator
{
	...
	public class BaseToggleBgMediator extends Mediator implements IMediator
	{
		public static const name:String = 'PBaseToggleBgMediator';
		protected var _view:BaseToggleBgView;
		public function get view():BaseToggleBgView{ return _view; }
		
		public function BaseToggleBgMediator()
		{
			super( name );
		}
